...
% *********************************************************************************************************************************************
% INPUT: (eyeType, subjectType, quarterType, suggestedLocationNumber, locationCoordsWithLabels, existingLocationNumbers, importPath, location*)
%        *may be empty
% *********************************************************************************************************************************************
...
locationCoordsWithLabels = varargin{6};
...
plotPreviousLocations(handles, locationCoordsWithLabels);
...
function plotPreviousLocations(handles, locationCoordsWithLabels)
    colour = 'r';

    for i=1:length(locationCoordsWithLabels)
        coords = locationCoordsWithLabels{i}.coords;
        label = locationCoordsWithLabels{i}.label;
        
        plot(coords(1), coords(2), handles.MarkerStyle, 'MarkerSize', handles.MarkerSize, 'MarkerEdgeColor', colour, 'MarkerFaceColor', colour);
        text(coords(1)+0.03, coords(2)-0.03, label, 'Color', colour);
    end
end
