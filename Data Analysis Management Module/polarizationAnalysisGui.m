...
% --------------------------------------------------------------------
function subsectionStatisticsModule_Callback(hObject, eventdata, handles)
% hObject    handle to subsectionStatisticsModule (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

subsectionStatisticsModule(hObject, eventdata, handles);


% --------------------------------------------------------------------
function sensitivityAndSpecificityAnalysisModule_Callback(hObject, eventdata, handles)
% hObject    handle to sensitivityAndSpecificityAnalysisModule (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

sensitivityAndSpecificityAnalysisModule(hObject, eventdata, handles);


% --- Executes on selection change in trialSessionSelect.
function trialSessionSelect_Callback(hObject, eventdata, handles)
% hObject    handle to trialSessionSelect (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns trialSessionSelect contents as cell array
%        contents{get(hObject,'Value')} returns selected item from trialSessionSelect

trialSessionSelect(hObject, eventdata, handles);


% --- Executes during object creation, after setting all properties.
function trialSessionSelect_CreateFcn(hObject, eventdata, handles)
% hObject    handle to trialSessionSelect (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
