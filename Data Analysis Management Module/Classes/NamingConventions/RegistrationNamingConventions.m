classdef RegistrationNamingConventions
    % RegistrationNamingConventions
    % naming constants for legacy registration
    
    properties (Constant)       
        % directories
        SESSION_DIR_SUBTITLE = 'Registration';
    ...
    methods (Static)
        ...
        function namingConventions = getMMNamingConventions()
            ...
            for i=1:length(RegistrationNamingConventions.MM_IMAGES_PSG)
                for j=1:length(RegistrationNamingConventions.MM_IMAGES_PSA)
                    import = strcat(RegistrationNamingConventions.MM_IMAGES_PSG{i}.import{1}, RegistrationNamingConventions.MM_IMAGES_PSA{j}.import{1});
                    project = {RegistrationNamingConventions.MM_IMAGES_PSG{i}.getSingularProjectTag(), RegistrationNamingConventions.MM_IMAGES_PSA{j}.getSingularProjectTag()};
