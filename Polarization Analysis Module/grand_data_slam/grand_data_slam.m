...
for i=1:height(metric_labels)
   fprintf(mean_vals,'Pos,Neg,'); %sub-column pos and neg headers
   fprintf(stdev_vals,'Pos,Neg,');
   fprintf(median_vals,'Pos,Neg,');
   fprintf(skew_vals,'Pos,Neg,');
end
...
%             fprintf(unpaired_t_test_vals, strcat(',',char(locations(j))));
        ...
        for k=1:length(metric_labels)
            fprintf(mean_vals, ',%6.4f,%6.4f', pos_data(k,3), neg_data(k,3));
            fprintf(stdev_vals, ',%6.4f,%6.4f', pos_data(k,4), neg_data(k,4));
            fprintf(median_vals, ',%6.4f,%6.4f', pos_data(k,5), neg_data(k,5));
            fprintf(skew_vals, ',%6.4f,%6.4f', pos_data(k,6),neg_data(k,6));
...
for i = 1:height(metric_labels)
    fprintf(mean_vals, ',%6.4f,%6.4f', mean(mean_positive_values(i,:)), mean(mean_negative_values(i,:)));
    fprintf(stdev_vals, ',%6.4f,%6.4f', mean(stdev_positive_values(i,:)), mean(stdev_negative_values(i,:)));
    fprintf(median_vals, ',%6.4f,%6.4f', mean(median_positive_values(i,:)), mean(median_negative_values(i,:)));
    fprintf(skew_vals, ',%6.4f,%6.4f', mean(skew_positive_values(i,:)), mean(skew_negative_values(i,:)));
end
...
for i = 1:height(metric_labels)
    fprintf(mean_vals, ',%6.4f,%6.4f', std(mean_positive_values(i,:)), std(mean_negative_values(i,:)));
    fprintf(stdev_vals, ',%6.4f,%6.4f', std(stdev_positive_values(i,:)), std(stdev_negative_values(i,:)));
    fprintf(median_vals, ',%6.4f,%6.4f', std(median_positive_values(i,:)), std(median_negative_values(i,:)));
    fprintf(skew_vals, ',%6.4f,%6.4f', std(skew_positive_values(i,:)), std(skew_negative_values(i,:)));
end
...
for i = 1:height(metric_labels)
    fprintf(mean_vals, ',%6.4f,%6.4f', median(mean_positive_values(i,:)), median(mean_negative_values(i,:)));
    fprintf(stdev_vals, ',%6.4f,%6.4f', median(stdev_positive_values(i,:)), median(stdev_negative_values(i,:)));
    fprintf(median_vals, ',%6.4f,%6.4f', median(median_positive_values(i,:)), median(median_negative_values(i,:)));
    fprintf(skew_vals, ',%6.4f,%6.4f', median(skew_positive_values(i,:)), median(skew_negative_values(i,:)));
end
...
for i = 1:height(metric_labels)
    fprintf(mean_vals, ',%6.4f,%6.4f', skewness(mean_positive_values(i,:)), skewness(mean_negative_values(i,:)));
    fprintf(stdev_vals, ',%6.4f,%6.4f', skewness(stdev_positive_values(i,:)), skewness(stdev_negative_values(i,:)));
    fprintf(median_vals, ',%6.4f,%6.4f', skewness(median_positive_values(i,:)), skewness(median_negative_values(i,:)));
    fprintf(skew_vals, ',%6.4f,%6.4f', skewness(skew_positive_values(i,:)), skewness(skew_negative_values(i,:)));
end
