classdef MuellerMatrixNormalizationTypes
    ...
    enumeration
        ...
        mm00Max     ('Max 0,0 Index Normalization (Usual)', 'The maximum value of the "0,0" index pixels is found. All pixels are then divided by this value. By using this type of normalization, the "0,0" image will show detail.')
    end
