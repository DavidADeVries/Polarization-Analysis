...
varargout{1} = handles.stain;
varargout{2} = handles.slideMaterial;
varargout{3} = handles.quarterType;
varargout{4} = handles.quarterArbitrary;
varargout{5} = handles.quarterNumber;
varargout{6} = handles.fixingDate;
varargout{7} = handles.fixingDoneBy;
varargout{8} = handles.quarterNotes;
